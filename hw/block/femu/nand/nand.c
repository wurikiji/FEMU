...
static void init_nand_flash_timing(FemuCtrl *n)
{
    nand_flash_timing = (NandFlashTiming){
        ...
        .pg_rd_lat[MLC] = {[MLC_LOWER_PAGE] = MLC_LOWER_PAGE_READ_LATENCY_NS, [MLC_UPPER_PAGE] = MLC_UPPER_PAGE_READ_LATENCY_NS},
        .pg_rd_lat[TLC] = {
        ...
        .pg_wr_lat[MLC] = {[MLC_LOWER_PAGE] = MLC_LOWER_PAGE_WRITE_LATENCY_NS, [MLC_UPPER_PAGE] = MLC_UPPER_PAGE_WRITE_LATENCY_NS},
        .pg_wr_lat[TLC] = {
